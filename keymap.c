...
[_LOWER] =
{
 ...
 {KC_ENT,  _______, _______, _______, _______, _______, _______, KC_MINS,    KC_EQL,     KC_LBRC, KC_RBRC, KC_BSLS}, 
 {_______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______, S(KC_NUHS), S(KC_NUBS), _______, _______, _______}, 
